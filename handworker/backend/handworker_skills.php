     <?php $baseurl = "http://localhost/handworker/backend/assets/";  ?>
...
// $db2->where('category_name', 'Carpanter');
$users = $db2->get('user');
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php if($users) { foreach ($users as $user){
                  ...
                  $db2->where('user_id',$user['user_id']);
                  $handworker_skills = $db2->get('handworker_skills');
                  ...
                  foreach($handworker_skills as $handworker_skill)
                  {
                     $detail_skill .= $handworker_skill['skills'].'<br>';
                     $detail_detail .= $handworker_skill['detail'].'<br>';
                  }
                ...
                <td><?php echo $user['user_name'] ?></td>
                  ...
                  <td><?php echo $detail_skill ?></td>
                  <td><?php echo $detail_detail ?></td>
...
<!-- jQuery 3.1.1 -->
<script src="<?php echo $baseurl;  ?>plugins/jQuery/jquery-3.1.1.min.js"></script>
<!-- jQuery UI 1.11.4 -->
