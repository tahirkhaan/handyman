...
$db2->where('category_name', 'Electrician');
$category1 = $db2->get('category');
    ...
    <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php if($category1) { foreach ($category1 as $category){



                  $db2->where('category_id',$category['category_id']);
                  $sub_category = $db2->getone('sub_category');
